...
public class Email {
    ...
    private void configuredBrowser(){
    ...
    public static ArrayList<String> getEmailAndPsw(){
        ...
        WebElement selectMonth = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(" //*[@id=\"month\"]")));
        selectMonth.click();
        ...
        WebElement selectGender = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"gender\"]")));
        selectGender.click();
